...
const uint CAPTURE_PIN_BASE = 21;   /* the first pin number */
const uint CAPTURE_PIN_COUNT = 1;   /* total number of pins based on PIN_BASE*/
const uint CAPTURE_N_SAMPLES = 1024;  /* total sample cycles of one pin */
...
int main() {
    ...
    while(gpio_get(QTPY_BOOT_PIN)>0);
